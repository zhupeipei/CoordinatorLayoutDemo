...
public class SimpleHeadBehavior extends CoordinatorLayout.Behavior<TextView> {
    ...
    public SimpleHeadBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private boolean canScroll(TextView child, float scrollY) {
        // scrollY > 0 表示向上滑动
